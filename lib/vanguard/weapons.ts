...
export const WEAPONS: WeaponDef[] = [
  ...
  {
    id: "deagle", name: "Desert Eagle", category: "pistol", icon: "🔫", auto: false,
    damage: 58, falloffStart: 8, falloffEnd: 22, minMult: 0.65, headMult: 2.1, rpm: 260, pellets: 1,
    magazine: 7, reserve: 56, reloadTime: 1.4, spread: 0.03, adsSpread: 0.01, adsZoom: 1.2,
    recoil: 0.05, moveMult: 1.02, range: 30, sound: "pistol", unlockLevel: 5, color: "#d4a017",
  },
  {
    id: "glock", name: "G18 Machine Pistol", category: "pistol", icon: "🔫", auto: true,
    damage: 20, falloffStart: 5, falloffEnd: 15, minMult: 0.5, headMult: 1.6, rpm: 1100, pellets: 1,
    magazine: 18, reserve: 108, reloadTime: 1.2, spread: 0.05, adsSpread: 0.03, adsZoom: 1.15,
    recoil: 0.014, moveMult: 1.09, range: 20, sound: "pistol", unlockLevel: 7, color: "#94a3b8",
  },
  {
    id: "p90", name: "P90", category: "smg", icon: "🔩", auto: true,
    damage: 19, falloffStart: 5, falloffEnd: 16, minMult: 0.5, headMult: 1.5, rpm: 900, pellets: 1,
    magazine: 50, reserve: 250, reloadTime: 2.0, spread: 0.038, adsSpread: 0.018, adsZoom: 1.2,
    recoil: 0.009, moveMult: 1.06, range: 20, sound: "smg", unlockLevel: 6, color: "#22d3ee",
  },
  {
    id: "ump45", name: "UMP-45", category: "smg", icon: "🔩", auto: true,
    damage: 26, falloffStart: 6, falloffEnd: 18, minMult: 0.5, headMult: 1.6, rpm: 640, pellets: 1,
    magazine: 25, reserve: 150, reloadTime: 1.6, spread: 0.03, adsSpread: 0.014, adsZoom: 1.25,
    recoil: 0.016, moveMult: 1.02, range: 24, sound: "smg", unlockLevel: 5, color: "#a78bfa",
  },
  {
    id: "scar", name: "SCAR-H", category: "rifle", icon: "🗡", auto: true,
    damage: 40, falloffStart: 11, falloffEnd: 30, minMult: 0.62, headMult: 1.7, rpm: 560, pellets: 1,
    magazine: 20, reserve: 160, reloadTime: 2.1, spread: 0.03, adsSpread: 0.008, adsZoom: 1.5,
    recoil: 0.022, moveMult: 0.97, range: 38, sound: "rifle", unlockLevel: 7, color: "#84cc16",
  },
  {
    id: "aug", name: "AUG A3", category: "rifle", icon: "🗡", auto: true,
    damage: 32, falloffStart: 10, falloffEnd: 28, minMult: 0.6, headMult: 1.75, rpm: 680, pellets: 1,
    magazine: 30, reserve: 210, reloadTime: 1.9, spread: 0.026, adsSpread: 0.006, adsZoom: 1.6,
    recoil: 0.016, moveMult: 0.99, range: 36, sound: "rifle", unlockLevel: 9, color: "#2dd4bf",
  },
  {
    id: "famas", name: "FAMAS", category: "rifle", icon: "🗡", auto: true,
    damage: 27, falloffStart: 9, falloffEnd: 26, minMult: 0.58, headMult: 1.7, rpm: 900, pellets: 1,
    magazine: 25, reserve: 175, reloadTime: 1.8, spread: 0.03, adsSpread: 0.009, adsZoom: 1.4,
    recoil: 0.018, moveMult: 1.0, range: 32, sound: "rifle", unlockLevel: 6, color: "#f472b6",
  },
  {
    id: "awp", name: "AWM", category: "sniper", icon: "🎯", auto: false,
    damage: 130, falloffStart: 22, falloffEnd: 64, minMult: 0.9, headMult: 2.6, rpm: 41, pellets: 1,
    magazine: 5, reserve: 30, reloadTime: 3.2, spread: 0.02, adsSpread: 0.0004, adsZoom: 3.4,
    recoil: 0.055, moveMult: 0.9, range: 90, sound: "sniper", unlockLevel: 9, color: "#0ea5e9",
  },
  {
    id: "rpk", name: "RPK", category: "lmg", icon: "⚙", auto: true,
    damage: 32, falloffStart: 12, falloffEnd: 32, minMult: 0.62, headMult: 1.5, rpm: 600, pellets: 1,
    magazine: 75, reserve: 225, reloadTime: 3.8, spread: 0.042, adsSpread: 0.016, adsZoom: 1.35,
    recoil: 0.018, moveMult: 0.88, range: 36, sound: "lmg", unlockLevel: 11, color: "#fbbf24",
  },
  {
