...
const PATHS: Record<IconName, ReactNode> = {
  ...
  card: <><rect x="2.5" y="5" width="19" height="14" rx="2.5" /><path d="M2.5 9.5h19" /><rect x="5.5" y="12.8" width="3.6" height="3" rx="0.6" /></>,
  note: <><path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z" /><path d="M14 3v5h5M9 13h6M9 17h4" /></>,
  id: <><rect x="3" y="4" width="18" height="16" rx="2.5" /><circle cx="9" cy="10" r="2.2" /><path d="M5.8 16c.5-1.7 1.8-2.4 3.2-2.4s2.7.7 3.2 2.4M14.5 9.5h4M14.5 13h4" /></>,
  shield: <><path d="M12 3 5 6v5c0 4.3 2.9 7.8 7 9 4.1-1.2 7-4.7 7-9V6z" /><path d="m9 12 2 2 4-4" /></>,
  ...
  settings: <><circle cx="12" cy="12" r="3.1" /><path d="M19.4 13a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9v.09a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" /></>,
...
const EN = {
  ...
  importSub: "Paste an export from your browser or password manager — or any messy text with logins in it. Vault detects the format and pulls out every credential. Everything stays on this device.",
  importPaste: "Paste CSV or text here…",
  importChooseFile: "Choose a .csv / .txt file",
  importDetected: "detected",
  importNothing: "No credentials detected yet. Paste a browser export or some login text above.",
  ...
  importItems: "items",
  importDone: "Imported",
  importSources: "Works with Chrome, Edge, Firefox, Safari, Bitwarden, 1Password, LastPass, KeePass & more.",
  importFormat: "Format",
  detectPaste: "Paste & detect",
  saveFailed: "Couldn't save — storage may be full or blocked. Try exporting a backup.",
  ...
  desktopHint: "Prefer a real desktop app? A native C++ build (Qt6 + libsodium, Argon2id) with a system tray, auto-lock and clipboard wipe is available as a .deb.",
  desktopCta: "Get the app",
...
const FA: VaultStrings = {
  ...
  importDetect: "وارد کردن و تشخیص",
  importTitle: "واردکردنِ رمزها",
  importSub: "خروجیِ مرورگر یا مدیرِ رمزت را بچسبان — یا هر متنِ نامرتبی که رمز و ورود دارد. والت خودش قالب را تشخیص می‌دهد و همه‌ی اطلاعاتِ ورود را بیرون می‌کشد. همه‌چیز روی همین دستگاه می‌ماند.",
  importPaste: "CSV یا متن را اینجا بچسبان…",
  importChooseFile: "انتخابِ فایلِ csv / txt",
  importDetected: "تشخیص داده شد",
  importNothing: "هنوز چیزی تشخیص داده نشد. خروجیِ مرورگر یا متنِ ورود را بالا بچسبان.",
  importSelectAll: "انتخابِ همه",
  importDeselectAll: "لغوِ همه",
  importInto: "واردکردن به",
  importAdd: "افزودن",
  importItems: "مورد",
  importDone: "وارد شد",
  importSources: "با کروم، اج، فایرفاکس، سافاری، Bitwarden، 1Password، LastPass، KeePass و … کار می‌کند.",
  importFormat: "قالب",
  detectPaste: "چسباندن و تشخیص",
  saveFailed: "ذخیره نشد — شاید فضای ذخیره‌سازی پُر یا مسدود است. یک پشتیبان بگیر.",
  ...
  desktopHint: "اپِ دسکتاپِ واقعی می‌خواهی؟ نسخه‌ی بومیِ ++C (با Qt6 و libsodium و Argon2id) با سینی سیستم، قفلِ خودکار و پاک‌سازیِ کلیپ‌بورد به‌صورتِ .deb موجود است.",
  desktopCta: "دریافتِ اپ",
